...
export const ModalHeaderTitleMarker = styled.div`
    width: 1.5rem;
    height: 1.5rem;
    border-radius: 50%;
...
export const ModalHeaderTitleText = styled.h1`
    font-weight: bold;
    font-size: 1.5rem;
    line-height: 2rem;
`;
...
export const ModalBodyInfoCenter = styled.div`
    width: 100%;
    display: flex;
    justify-content: center;
    align-items: center;
...
export const ModalBodyInfoWrapper = styled.div`
    width: 90%;
    display: flex;
    flex-direction: column;
    justify-content: center;
...
export const ModalBodyInfoTitle = styled.p`
    font-weight: 600;
    font-size: 10px;
    line-height: 20px;
...
export const EnlistmentImg = styled.img` margin-right: 1rem; `;
export const EnlistmentDate = styled.p``;
export const EnlistmentAction = styled.p`
    cursor: pointer;
    color: #001196;
    padding-left: 1rem;
