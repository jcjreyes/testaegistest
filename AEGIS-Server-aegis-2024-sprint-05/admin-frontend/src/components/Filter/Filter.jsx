...
const Filter = ({ sortOptions, searchFilter, onChange, handleSortChange, exportButton }) => {
    // Create a state
    ...
    return (
        <FilterContainer>
            <FilterRow>
                <Search onChange={onChange} placeholder="Search for a student name or ID number..." />
                <FilterSwitch>
            ...
            <FilterRow>
                <FilterOptions>
                    <Select styles={selectStyles} options={sortOptions} placeholder="Sort by" id="sortOptions" onChange={handleSortChange}/>
                    {/* <FilterTags>
                        <FilterTagsLabel>Filter Tags</FilterTagsLabel>
                        <FilterTagsPlaceholder>+ Add</FilterTagsPlaceholder>
                    </FilterTags> */}
                </FilterOptions>
                <Button type="button" reverse={true} paddingX="16px" paddingY="8px" label="Export as CSV" onClick={exportButton} />
            </FilterRow>
        </FilterContainer>
    )
}
